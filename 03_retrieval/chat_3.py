...
text_splitter = SpacyTextSplitter(chunk_size=200, pipeline="ja_core_news_sm")
...
async def on_chat_start():
    ...
    database = Chroma(
        ...
        # does not specify persist_directory, so it will be in memory
    )
